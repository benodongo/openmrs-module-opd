...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-2">
                <a style="text-decoration: none" href="<c:url value='/module/outpatient/listImmunization.form'/> ">
                    <i class="fa fa-stethoscope fa-5x"></i><br>
                    <span>Child Clinic</span>
                </a>
            </div>
            <div class="col-md-2">
                <a style="text-decoration: none" href="<c:url value='/module/outpatient/listMaternal.form'/> ">
                    <i class="fa fa-user-md fa-5x"></i><br>
                    <span>Maternal Care</span>
                </a>
            </div>
            <div class="col-md-2">
                <a style="text-decoration: none" href="<c:url value='/module/outpatient/listHiv.form'/> ">
                    <i class="fa fa-user-md fa-5x"></i><br>
                    <span>Hiv Care</span>
                </a>
            </div>
